...
pub trait Planet {
    ...
    fn calc_duration(d: &Duration) -> f64 {
        d.0 / EARTH_SECONDS
    }
}
...
impl Planet for Mercury {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 0.2408467
    }
}

impl Planet for Venus {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 0.61519726
    }
}

impl Planet for Earth {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 1.0
    }
}

impl Planet for Mars {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 1.8808158
    }
}

impl Planet for Jupiter {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 11.862615
    }
}

impl Planet for Saturn {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 29.447498
    }
}

impl Planet for Uranus {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 84.016846
    }
}

impl Planet for Neptune {
    fn years_during(d: &Duration) -> f64 {
        Self::calc_duration(d) / 164.79132
    }
}
